...
public class Reading extends EcruBase {
	 ...
	 * @param title
	 */
	public Reading(String id, String displayLabel, String annotation,
			List<String> authors,
	 ...
	 * @return
	 */
	public static Reading createJournal(String id, String displayLabel, 
			String annotation,List<String> authors,
			String availUrl, String catId, String courseId, String digUrl, String doiId,Date endDate,
			 String journal, Date lectureDate,
			String library, int order, String pubmed, boolean required, String status, Date startDate,
			String system, String term, String title) {
		return new Reading(id, displayLabel, annotation, authors, availUrl, catId, null, 
				courseId, digUrl, doiId, null, endDate, null, null, journal, lectureDate, 
				library, order, pubmed, required, status, startDate, system, term, title);
	}
	 ...
	 * @return
	 */
	public static Reading createNonJournal(String id, String displayLabel, 
			String annotation, List<String> authors,
			String availUrl, String catId, String chapter, String courseId,
			String digUrl, List<String> editors, Date endDate,
			String isbn, String issn, String journal, Date lectureDate,
			String library, int order, boolean required, String status, Date startDate,
			String system, String term, String title) {
		
		return new Reading(id, displayLabel, annotation, authors, availUrl, catId, null, 
				courseId, digUrl, null,editors, endDate, isbn, issn, null, lectureDate,
				library, order, null,  required, status, startDate, system, term, title);
	}
