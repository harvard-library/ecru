 ...
 */
	...
	public  Reading toReading() throws ClassCastException {
		...
		Reading r = new Reading(this.getId(), this.getDisplayLabel(), 
				this.getAnnotation(), this.getAuthors(),
				this.getAvailUrl(), this.getSysId(), this.getChapter(), this.getCourseId(),
				this.getDigUrl(), this.getDoiId(), this.getEditors(), 
				this.getEndDate(), this.getIsbn(), this.getIssn(),
				this.getJournal(), this.getLectureDate(), this.getLibrary(),
				this.getOrder(), this.getPubmed(),
